        ...
        {page === 1 && (
          <Grid container xs={12} sx={{ border: 0, padding:0}}>    
            <Grid sx={{ border: 0, padding:2}} xs={6}>
              <Box sx={{ border: 2, padding: 2, bgcolor: 'green', marginBottom: 2 }}>
                <h1>Kettle</h1> 
            ...
            <Grid sx={{ border: 0, padding:2}} xs={6}>
              ...
              <Box sx={{ border: 2, padding: 2, bgcolor: 'green', marginBottom: 0 }}>
                  <ToggleButton
                    style={{
        ...
        {page === 3 && (
          <Grid container xs={12} sx={{ border: 0, padding:0}}>    
            <Grid sx={{ border: 0, padding:2}} xs={12}>
              <Box sx={{ border: 1, padding: 2, bgcolor: 'green', marginBottom: 2 }}>
                <h1>Chiller</h1>
